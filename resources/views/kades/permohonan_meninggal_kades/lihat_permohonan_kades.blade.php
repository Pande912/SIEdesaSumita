...
@section('title')
<title>SIE Desa Sumita - Surat Permohonan Meninggal - Lihat Data Surat Permhohonan </title>
@endsection
@section('content')
@section('content')
                ...
                <div class="card-body">
                    <div class="form">
                        <form action="/permohonan_Meninggal/{{$permohonan_meninggal->id}}/update" id="EditForm" method="POST" >
                            ...
                            <a onclick="return confirm('Yakin Menyetujui Permohonan ini?')" href="{{url('permohonan_meninggal_kades/konfirmasi_setuju/'.$permohonan_meninggal->id, [])}}" class="btn btn-success btn-icon-split">
                                <span class="text">Setuju</span>
                            </a>
                            <a onclick="return confirm('Yakin Menolak Permohonan ini?')" href="{{url('permohonan_meninggal_kades/konfirmasi_tolak/'.$permohonan_meninggal->id, [])}}" class="btn btn-danger btn-icon-split">
                                <span class="text">Tolak</span>
                            </a>
                            <a href="/permohonan_meninggal_kades" class="btn btn-secondary btn-icon-split">
