...
@section('title')
<title>SIE Desa Sumita - Surat Permohonan KTP - Lihat Data Surat Permhohonan </title>
@endsection
@section('content')
@section('content')
                    ...
                    <div class="form">
                        <form action="/permohonan_ktp/{{$permohonan_ktp->id}}/update" id="tambahUserForm" method="POST" >
                            ...
                            <div class="form-group">
                                ...
                                oninvalid="this.setCustomValidity('Kolom tanggal ktp Tidak Boleh Kosong')"
                                oninput="this.setCustomValidity('')">
                            </div>
                            <div class="mb-3">
                              ...
                              <a onclick="return confirm('Yakin Menyetujui Permohonan ini?')" href="{{url('permohonan_ktp_kades/konfirmasi_setuju/'.$permohonan_ktp->id, [])}}" class="btn btn-success btn-icon-split">
                                <span class="text">Setuju</span>
                            </a>
                            <a onclick="return confirm('Yakin Menolak Permohonan ini?')" href="{{url('permohonan_ktp_kades/konfirmasi_tolak/'.$permohonan_ktp->id, [])}}" class="btn btn-danger btn-icon-split">
                                <span class="text">Tolak</span>
                            </a>
                            <a href="/permohonan_ktp_kades" class="btn btn-secondary btn-icon-split">
