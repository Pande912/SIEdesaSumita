...
@section('title')
<title>SIE Desa Sumita - Surat Permohonan Pindah - Lihat Data Surat Permhohonan </title>
@endsection
@section('content')
                ...
                <div class="card-body">
                    <div class="form">
                        <form action="/permohonan_Pindah/{{$permohonan_pindah->id}}/update" id="tambahUserForm" method="POST" >
                            ...
                            <a onclick="return confirm('Yakin Menyetujui Permohonan ini?')" href="{{url('permohonan_pindah_kades/konfirmasi_setuju/'.$permohonan_pindah->id, [])}}" class="btn btn-success btn-icon-split">
                                <span class="text">Setuju</span>
                            </a>
                            <a onclick="return confirm('Yakin Menolak Permohonan ini?')" href="{{url('permohonan_pindah_kades/konfirmasi_tolak/'.$permohonan_pindah->id, [])}}" class="btn btn-danger btn-icon-split">
                                <span class="text">Tolak</span>
                            </a>
                            <a href="/permohonan_pindah_kades" class="btn btn-secondary btn-icon-split">
