...
@section('title')
<title>SIE Desa Sumita - Surat Permohonan Lahir - Lihat Data Surat Permhohonan </title>
@endsection
@section('content')
                    ...
                    <div class="form">
                        <form action="/permohonan_lahir/create" id="tambahUserForm" method="POST" >
                            ...
                            <div class="mb-3">
                              ...
                              <a onclick="return confirm('Yakin Menyetujui Permohonan ini?')" href="{{url('permohonan_lahir_kades/konfirmasi_setuju/'.$permohonan_lahir->id, [])}}" class="btn btn-success btn-icon-split">
                                <span class="text">Setuju</span>
                            </a>
                            <a onclick="return confirm('Yakin Menolak Permohonan ini?')" href="{{url('permohonan_lahir_kades/konfirmasi_tolak/'.$permohonan_lahir->id, [])}}" class="btn btn-danger btn-icon-split">
                                <span class="text">Tolak</span>
                            </a>
                            <a href="/permohonan_lahir_kades" class="btn btn-secondary btn-icon-split">
