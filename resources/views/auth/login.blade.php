...
<head>
	<title>Login | Sistem Informasi Eksekutif Pada Desa Sumita</title>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<!-- VENDOR CSS -->
	<link rel="stylesheet" href="{{asset('admin/assets/css/bootstrap.min.css')}}">
	<link rel="stylesheet" href="{{asset('admin/assets/vendor/font-awesome/css/font-awesome.min.cs')}}">
				...
				<div class="auth-box ">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Sistem Informasi Pada Desa Sumita</h1>
						</div>
					</div>
