...
@section('title')
<title>SIE Desa Sumita - Surat Permohonan Lahir - Tambah Data Surat Permohonan </title>
@endsection
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
         ...
         <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h6 class="h6 mb-5 text-gray-800">Manajemen Data Surat Permohonan Lahir - Tambah Data Surat</h6>
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">Form Tambah  Data Permohonan Lahir</h5>
                </div>
                <div class="card-body">
                    <div class="form">
                        <form action="/permohonan_lahir/create" id="tambahUserForm" method="POST" >
                            ...
                            <div class="form-group">
                                ...
                                <input name="tgl_lahir" type="date" class="form-control"   aria-describedby="emailHelp" required placeholder=""
                            ...
                            <div class="mb-3">
                                ...
                                <input name="anak_ke" type="text" class="form-control" id="text" aria-describedby="text" required placeholder="Anak ke-"
                                oninvalid="this.setCustomValidity('Kolom Tidak Boleh Kosong')"
                                oninput="this.setCustomValidity('')" >
                              </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nama Saksi 1 </label>
                                <input name="nama_saksi_1" type="text" class="form-control" id="text" aria-describedby="text" required placeholder="Nama Saksi 1"
                                oninvalid="this.setCustomValidity('Kolom Tidak Boleh Kosong')"
                                oninput="this.setCustomValidity('')" >
                              </div>
                              <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Alamat Saksi 1 </label>
                                <input name="alamat_saksi_1" type="text" class="form-control" id="text" aria-describedby="text" required placeholder="Alamat Saksi 1"
                                oninvalid="this.setCustomValidity('Kolom Tidak Boleh Kosong')"
                                oninput="this.setCustomValidity('')" >
                              </div>
                              <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Pekerjaan Saksi 1 </label>
                                <input name="pekerjaan_saksi_1" type="text" class="form-control" id="text" aria-describedby="text" required placeholder="Pekerjaan Saksi 1"
                                oninvalid="this.setCustomValidity('Kolom Tidak Boleh Kosong')"
                                oninput="this.setCustomValidity('')" >
                              </div>
                              <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nama Saksi 2 </label>
                                <input name="nama_saksi_2" type="text" class="form-control" id="text" aria-describedby="text" required placeholder="Nama Saksi 2"
                                oninvalid="this.setCustomValidity('Kolom Tidak Boleh Kosong')"
                                oninput="this.setCustomValidity('')" >
                              </div>
                              <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Alamat Saksi 2 </label>
                                <input name="alamat_saksi_2" type="text" class="form-control" id="text" aria-describedby="text" required placeholder="Alamat Saksi 2"
                                oninvalid="this.setCustomValidity('Kolom Tidak Boleh Kosong')"
                                oninput="this.setCustomValidity('')" >
                              </div>
                              <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Pekerjaan Saksi 2 </label>
                                <input name="pekerjaan_saksi_2" type="text" class="form-control" id="text" aria-describedby="text" required placeholder="Pekerjaan Saksi 2"
                                oninvalid="this.setCustomValidity('Kolom Tidak Boleh Kosong')"
                                oninput="this.setCustomValidity('')" >
                              </div>
