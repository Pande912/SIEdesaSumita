        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
         ...
         <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="my-2">
                        <a href="/permohonan_Meninggal/tambah_permohonan" class="btn btn-success btn-icon-split">
                        ...
                        <table class="table table-hover table-sm table-bordered"  width="100%" cellspacing="0">
                            ...
                            <tbody >
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        @if ($item->status == 'proses')
                                        <a href="/permohoanan_Meninggal/{{$item->id}}/edit_permohonan" class="btn btn-info btn-square btn-sm">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="/permohoanan_Meninggal/{{$item->id}}/lihat_permohonan" class="btn btn-secondary btn-square btn-sm">
    ...
    $('.delete').click(function(){
        var permohonanItem_id = $(this).attr('permohonanItem-id');
            ...
            if (result.isConfirmed) {
                window.location = "/permohonan_Meninggal/"+ permohonanItem_id +"/delete";
            }
            });
        });
</script>
