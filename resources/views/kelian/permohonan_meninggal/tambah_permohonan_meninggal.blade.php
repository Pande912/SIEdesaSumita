...
@section('title')
<title>SIE Desa Sumita - Surat Permohonan Meninggal - Tambah Data Surat Permohonan </title>
@endsection
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
         ...
         <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h6 class="h6 mb-5 text-gray-800">Manajemen Data Surat Permohonan Meninggal - Tambah Data Surat</h6>
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">Form Tambah  Data Permohonan Meninggal</h5>
                </div>
                <div class="card-body">
                    <div class="form">
                        <form action="/permohonan_Meninggal/create" id="tambahUserForm" method="POST" >
                            {{ csrf_field() }}
                            ...
                            <div class="mb-3">
                                ...
                                <input name="tempat_meninggal" type="text" class="form-control" id="text" aria-describedby="text" required placeholder="Tempat Meninggal"
                                oninvalid="this.setCustomValidity('Kolom Tidak Boleh Kosong')"
                                oninput="this.setCustomValidity('')" >
                              </div>

                              <div class="form-group">
                                <label for="exampleFormControlTextarea1">Keterngan</label>
