...
@section('title')
<title>SIE Desa Sumita - Surat Permohonan PIndah - Tambah Data Keluaraga Yang Ikut </title>
@endsection
@section('content')
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
         ...
         <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h6 class="h6 mb-5 text-gray-800">Manajemen Data Surat Permohonan Pindah - Tambah  Data Anggota Keluarga</h6>
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form">
                        <form action="/permohonan_pindah/{id}/tambah_anggota" id="tambahUserForm" method="POST" >
                            {{ csrf_field() }}
                            <div class="mb-3">
                                <input name="permohonan_pindah_id" type="hidden" readonly="readonly"  value="{{$permohonan_pindah->id}}" class="form-control" id="text" aria-describedby="text" required placeholder=""
