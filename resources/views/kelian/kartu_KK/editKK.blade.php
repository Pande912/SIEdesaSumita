...
<title>SIE Desa Sumita - Kartu KK - Edit Kartu KK</title>
@section('content')
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
         ...
         <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h6 class="h6 mb-5 text-gray-800">Manajemen Data KK - Edit Data KK</h6>
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">Form Edit  Data KK</h5>
                </div>
                <div class="card-body">
                    <div class="form">
                        <form action="/kartu_KK/{{$kartu_kk->id}}/update" id="tambahUserForm" method="POST" >
                            {{ csrf_field() }}
                            <div class="mb-3">
                              <label for="exampleInputEmail1" class="form-label">Nomer KK </label>
                              <input name="nomer_KK" value="{{$kartu_kk->nomer_KK}}" type="text" class="form-control" id="text" aria-describedby="text" required placeholder="Nomer KK"
                            ...
                            <div class="mb-3">
                                ...
                                <input name="alamat_KK" value="{{$kartu_kk->alamat_KK}}" type="text" class="form-control" id="text" aria-describedby="text" required placeholder="ALamat KK"
                                oninvalid="this.setCustomValidity('Kolom Tidak Boleh Kosong')"
                                oninput="this.setCustomValidity('')" >
                              </div>
