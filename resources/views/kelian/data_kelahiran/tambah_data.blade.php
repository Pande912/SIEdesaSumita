    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
         ...
         <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h6 class="h6 mb-5 text-gray-800">Manajemen Data Kelahiran - Tambah Data Kelahiran</h6>
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">Form Tambah  Data Kelahiran</h5>
                </div>
                <div class="card-body">
                    <div class="form">
                        <form action="/data_kelahiran/create" id="tambahUserForm" method="POST" >
                            {{ csrf_field() }}
