...
@section('title')
<title>SIE Desa Sumita -Data Kedatangan-Tambah Data Kedatangan</title>
@endsection
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
         ...
         <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h6 class="h6 mb-5 text-gray-800">Manajemen Data Kedatangan - Tambah Data Kedatangan</h6>
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">Form Tambah  Data Kedatangan</h5>
                </div>
                <div class="card-body">
                    <div class="form">
                        <form action="/data_kedatangan/create" id="tambahUserForm" method="POST" >
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <input name="tgl_datang" type="date" class="form-control"   aria-describedby="emailHelp" required placeholder=""
                                oninvalid="this.setCustomValidity('Kolom tanggal lahir Tidak Boleh Kosong')"
                                oninput="this.setCustomValidity('')">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="alamat_asal" type="text" class="form-control" id="text" aria-describedby="text" required placeholder="Alamat Asal"
                                oninvalid="this.setCustomValidity('Kolom Tidak Boleh Kosong')"
                                oninput="this.setCustomValidity('')" >
                              </div>
                              <div class="form-group">
                                <label for="exampleInputEmail1" class="form-label">Keterangan</label>
                                <input name="keterangan" type="text" class="form-control"   aria-describedby="emailHelp" required placeholder="Keterangan"
                                oninvalid="this.setCustomValidity('Kolom tanggal lahir Tidak Boleh Kosong')"
                                oninput="this.setCustomValidity('')">
                            </div>
