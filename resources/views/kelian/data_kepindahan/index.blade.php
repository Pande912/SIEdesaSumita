...
@section('title')
<title>SIE Desa Sumita -Data Kepindahan</title>
@endsection
@section('content')
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
         ...
         <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-5 text-gray-800">Manajemen Data Kepindahan</h1>
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">Data Kepindahan</h5>
                </div>
                <div class="card-body">
                    <div class="my-2">
                        <a href="/data_kepindahan/tambah_data" class="btn btn-success btn-icon-split">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-sm table-bordered"  width="100%" cellspacing="0">
                            ...
                            @foreach ($data_kepindahan as $index => $item)
                            <tbody >
                                <?php $no=1;?>
                                <tr>
                                    <th scope="row">{{ $index + $data_kepindahan->firstItem() }}</th>
                                    <td>{{$item->no_surat}}</td>
                                    ...
                                    <td> 
                                        <a href="/data_kepindahan/{{$item->id}}/edit_data" class="btn btn-info btn-square btn-sm">
    ...
    $('.delete').click(function(){
        var permohonanItem_id = $(this).attr('permohonanItem-id');
            ...
            if (result.isConfirmed) {
                window.location = "/data_kepindahan/"+ permohonanItem_id +"/delete";
            }
            });
        });
</script>
